...
def show():
    ...
    print(" Walking further into the carved path led her into an even more obscure place, where she saw " + Anything[0],)
    print (" So she " + PastVerbs[0],)
    print ("and " + PastVerbs[1] + " at full speed out of the forest. ")
